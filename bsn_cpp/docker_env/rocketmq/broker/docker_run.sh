...
mkdir -p ~/bsn_data/rocketmq_b1/opt/logs
mkdir -p ~/bsn_data/rocketmq_b1/opt/store

sudo docker rm bsn_rocketmq_b1
sudo docker run -d -p 10911:10911 -p 10909:10909 -v ~/bsn_data/rocketmq_b1/opt/logs:/opt/logs -v ~/bsn_data/rocketmq_b1/opt/store:/opt/store --name bsn_rocketmq_b1 --link bsn_rocketmq_n1:bsn_rocketmq_n1 -e "NAMESRV_ADDR=bsn_rocketmq_n1:9876"  bsn069/rocketmq_broker:latest
