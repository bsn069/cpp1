...
//     InitNeedPlug();
// 	RegAllCmd();
// 	StartClientTCPListen();
// 	StartClientUDPListen();
	
// 	return true;
// }


// bool C_PlugGate::StartClientTCPListen() {
// 	D_OutInfo();

// 	auto spI_Address = m_spI_PlugNet->NewI_Address();
// 	spI_Address->SetAddr("0.0.0.0");
// 	spI_Address->SetPort(60001);

// 	m_spI_TCPListen = m_spI_PlugNet->NewI_TCPListen();
...
// bool C_PlugGate::StartClientUDPListen() {
// 	D_OutInfo();
...
// 	m_spC_UDPServer = C_UDPServer::NewC_UDPServer(GetSPC_PlugGate(), spI_Address);
// 	m_spC_UDPServer->Start();
...
// 	m_spI_PlugCmd->RegPlugCmd(GetName(), "help", boost::bind(&C_PlugGate::CmdHelp, this, _1, _2));
